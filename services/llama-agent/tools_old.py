...
class HTTPGetTool(BaseTool):
    ...
    def metadata(self):
        ...
        return ToolMetadata(
            name="http_get",
            description=(
                "Use this tool when you need to retrieve data from an API endpoint. "
                "MANDATORY for browsing products, viewing pages, checking status, or getting information. "
                "Call immediately when your goal involves viewing/reading data. "
...
class HTTPPostTool(BaseTool):
    ...
    def metadata(self):
        ...
        return ToolMetadata(
            name="http_post",
            description=(
                "Use this tool when you need to submit data, login, create resources, or send information to an API. "
                "MANDATORY for authentication, form submissions, adding items to cart, creating accounts. "
                "Call immediately when your goal involves submitting/creating data. "
...
class HTTPPutTool(BaseTool):
    ...
    def metadata(self):
        ...
        return ToolMetadata(
            name="http_put",
            description=(
                "Use this tool when you need to update existing resources or modify data. "
                "MANDATORY for updating profiles, modifying cart items, changing settings. "
                "Call immediately when your goal involves updating/modifying existing data. "
                "Parameters: api_name (str), path (str), data (dict), headers (dict, optional)"
            )
        )
...
class HTTPDeleteTool(BaseTool):
    ...
    def metadata(self):
        ...
        return ToolMetadata(
            name="http_delete",
            description=(
                "Use this tool when you need to delete resources or cancel operations. "
                "MANDATORY for removing cart items, deleting accounts, canceling orders. "
                "Call immediately when your goal involves deleting/removing data. "
                "Parameters: api_name (str), path (str), headers (dict, optional)"
            )
        )
...
class StateUpdateTool(BaseTool):
    ...
    def metadata(self):
        ...
        return ToolMetadata(
            name="state_update",
            description=(
                "Use this tool when you need to save session data for future requests. "
                "MANDATORY after receiving authentication tokens, session cookies, or transaction IDs. "
                "Call immediately after successful login or when you receive session data from API responses. "
